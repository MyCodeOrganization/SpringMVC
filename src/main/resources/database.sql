...
CREATE TABLE `t_user` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户权限通用表';
...
CREATE TABLE `t_brand` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='品牌表';
...
CREATE TABLE `t_series` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='车系表';
...
CREATE TABLE `t_vehiclemodel` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='车型表，例如suv';
...
CREATE TABLE `t_color` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='颜色表';
...
CREATE TABLE `t_province` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='省份表';
...
CREATE TABLE `t_city` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='城市表';
...
CREATE TABLE `t_buycarinfo` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='买车信息表';
...
CREATE TABLE `t_infomation` (
  ...
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='资讯信息表';
...
CREATE TABLE `t_carinfo` (
  ...
  `visit_count` INT  COMMENT '访问量',
  `selled` smallint(2) DEFAULT '0' COMMENT '是否已出售，0：未售，1：已售，2：其他',
  `enabled` smallint(2) DEFAULT '1' COMMENT '是否被删除，1：未被删除，0：已删除',
  `insert_time` TIMESTAMP NULL COMMENT '录入时间',
  `lastupdate_time` TIMESTAMP NULL COMMENT '修改时间',
  `operator` varchar(50) DEFAULT '' COMMENT '操作人',
  `describ` text  COMMENT '备用描述信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='车辆信息表';
